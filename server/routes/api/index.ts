...
import ai from "./ai";
import agentSessions from "./agentSessions/agentSessions";
import agentSkills from "./agentSkills/agentSkills";
import agentSchedules from "./agentSchedules/agentSchedules";
import agentProviderKeys from "./agentProviderKeys/agentProviderKeys";
...
router.use("/", agentSessions.routes());
router.use("/", agentSkills.routes());
router.use("/", agentSchedules.routes());
router.use("/", agentProviderKeys.routes());
